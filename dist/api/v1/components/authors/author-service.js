...
exports.update = exports.create = exports.getPoemsList = exports.random = exports.searchAuthor = exports.getWithId = void 0;
// Modelos
...
function create(data_body) {
    return new Promise((resolve, reject) => {
        const response = response_data_1.default();
        let author = new author_model_1.default(data_body);
        author.save().then((poem) => {
            response.status = 400;
...
function update(id, data_body) {
    return new Promise((resolve, reject) => {
        const response = response_data_1.default();
        author_model_1.default.findByIdAndUpdate(id, data_body, { new: true }).then((authorResponse) => {
            response.is_valid = true;
            response.data = authorResponse;
            resolve(response);
        }).catch((err) => {
